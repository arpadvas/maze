...
export const gameItems = [
    new Door(otherAtlas, 0, 0, 16, 16, 64, 304, 16, 16, false, true, false, 0),
    new Door(otherAtlas, 0, 0, 16, 16, 288, 192, 16, 16, false, true, false, 0),
    new Chest(otherAtlas, 96, 0, 16, 16, 464, 176, 16, 16, false, true, false, 0),
    ...
    new Door(otherAtlas, 0, 0, 16, 16, 416, 64, 16, 16, false, true, false, 0),
    ...
    new Chest(otherAtlas, 96, 0, 16, 16, 464, 224, 16, 16, false, true, false, 0),
